...
export interface CardData {
  ...
  description?: string;
  /** Short description text displayed in top right (optional) */
  shortDescription?: string;
  /** Client/company name (optional) */
  client?: string;
  /** Logo image URL for top left (optional) */
  logo?: string;
...
export interface InfiniteGridOptions {
  ...
  gridGap?: number;
  /** Width of each tile in Three.js units (default: 4.5) */
  tileWidth?: number;
  /** Height of each tile in Three.js units (default: matches tileWidth, creates 1:1 square ratio) */
  tileHeight?: number;
  /** Size of each tile in Three.js units (default: 3) - DEPRECATED: use tileWidth/tileHeight */
  tileSize?: number;
